      ...
      <article className="py-12">
        <div className="container mx-auto max-w-4xl px-4">
          ...
          >
            ...
            <Card className="p-8">
              <div
                className="prose prose-lg max-w-none dark:prose-invert prose-headings:font-bold prose-h2:mb-4 prose-h2:mt-8 prose-h2:text-2xl prose-p:mb-4 prose-p:text-muted-foreground"
